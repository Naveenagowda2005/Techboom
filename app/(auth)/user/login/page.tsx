  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.data?.user?.role !== 'USER') {
        setApiError('Invalid credentials. This login is for referrers only.')
        return
      }
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mt-6 mb-2">Referrer Login</h1>
          <p className="text-white/50 text-sm">Sign in to your referrer account</p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
          ...
          <p className="text-center text-sm text-white/50 mt-6">
            ...
            <Link href="/user/signup" className="text-purple-400 hover:text-purple-300 font-medium">
              Sign up here
            </Link>
          </p>
