  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({ ...form, role: 'USER' }), // Explicitly set USER role
      })
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mt-6 mb-2">Become a Referrer</h1>
          <p className="text-white/50 text-sm">Start earning commissions today</p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
          ...
          <p className="text-center text-sm text-white/50 mt-4">
            ...
            <Link href="/user/login" className="text-purple-400 hover:text-purple-300 font-medium">
              Sign in
            </Link>
          </p>
